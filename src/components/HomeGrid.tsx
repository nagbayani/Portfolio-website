  ...
  return (
    <div className='home-grid w-[100%] h-[100%] font-garamond relative'>
      <div className='home-profile relative translate-y-[-5%] mx-[-1em] z-7 '>
        <HomePicSvg />
        <div className='top-profile w-[102%] overflow-hidden absolute'>
          <ProfileTopSvg />
        </div>
      </div>
      <h2 className='relative justify-self-end self-end row-start-2 col-start-1 mb-[-.5em] z-50'>
        Building
      </h2>
      ...
      <div className='relative row-start-5 col-start-1 mr-[.5rem]'>
        <h2 className='text-end'>web</h2>
        <h2 className='text-end mt-[-.75em]'>products</h2>
      </div>
      <div className='relative row-start-6 col-start-3'>
        <h2>is my</h2>
        <h2 className='mt-[-.75em]'>passion.</h2>
      </div>
      <div className='relative font-aileronRegular justify-self-center translate-x-[0%] row-start-8 col-start-2'>
